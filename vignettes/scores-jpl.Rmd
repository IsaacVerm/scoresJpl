...
- wat zijn de meest opmerkelijke verschillen in aantal goals?
- ...
...
- rekening houden met de volgorde (bv. hopen dat de resultaten altijd op de 8e plaats staan)
...
Op Wikipedia is voor seizoenen tot 2005/06 geen data beschikbaar over de resultaten zelf (enkel het eindklassement).

In deze analyse wordt geen rekening gehouden met het play-off systeem. Dit systeem is verschillende malen veranderd tussen 2006/07 en 2019/20 (de seizoenen waarvoor er data beschikbaar is). De reguliere competitie daarentegen heeft in de periode van onze dataset telkens hetzelfde format gehad.
...
Bij narekening blijkt onze berekening te kloppen op een detail na. In het seizoen 2009/10 zijn er slechts 230 wedstrijden. Bij [nader inzien](https://en.wikipedia.org/wiki/2009%E2%80%9310_Belgian_Pro_League) blijkt dit te verklaren doordat Moeskroen uit de competitie werd uitgesloten en bepaalde van hun wedstrijden werden verwijderd uit het officiële klassement. In het huidige seizoen zijn natuurlijk nog niet alle wedstrijden gespeeld.
...
Als we de index vergelijken met de grafiek hierboven lijkt dit te kloppen. 2016/17 lijkt inderdaad het meest afwijkenede seizoen te zijn met 2-1 als zowel meest frequente als meest aantrekkelijke score.
